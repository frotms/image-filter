#ifndef __PERMUTOHEDRAL_LATTICE_H
#define __PERMUTOHEDRAL_LATTICE_H
...
class PermutohedralLattice {
   ...
   */
  static PBFimage filter(PBFimage im, PBFimage ref) {
    //timeval t[5];
    ...
    PBFimage out(im.frames, im.width, im.height, im.channels);
